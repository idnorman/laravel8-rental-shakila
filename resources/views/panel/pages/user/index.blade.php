                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('panel.user.create') }}" class="btn btn-primary">Tambah Data</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->address }}</td>
                                                <td>
                                                    <a href="{{ route('panel.user.show', $user->id) }}"
                                                    ...
                                                    <a href="" class="btn btn-sm btn-danger d-block" data-toggle="modal"
                                                        data-target="#modal-default" data-id="{{ $user->id }}" data-name="{{ $user->name }}">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <form action="{{ route('panel.user.delete') }}" method="POST">
                        @csrf
                        @method('delete')
