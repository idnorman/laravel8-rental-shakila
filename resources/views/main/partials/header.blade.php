            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="index.html" class="nav-item nav-link {{ (url()->current() == url('/')) ? 'active' : '' }}">Home</a>
                        @auth
                        <a href="{{ route('main.profil') }}" class="nav-item nav-link {{ (strpos(currentPath(), 'profil') !== false ) ? 'active' : '' }}">Profil</a>
                        <a href="{{ route('main.logout') }}" class="nav-item nav-link">Keluar</a>
                        @endauth
                    </div>
                </div>
            </nav>
