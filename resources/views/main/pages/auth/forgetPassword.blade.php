...
@section('content')
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Lupa Password</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="{{ url('/') }}">Beranda</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Lupa Password</h6>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-5" id="target">
                    <div class="bg-secondary p-5">
                        ...
                        @endif
                        <form action="{{ route('main.forgetPasswordProcess') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <div>
                                    <input type="email" name="email"
                                        class="form-control p-4 @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email" />
                                    @error('email')
                            ...
                            <div class="form-group mb-0">
                                <button class="btn btn-primary btn-block" type="submit" style="height: 50px;">Dapatkan Password</button>
                            </div>
                        </form>
                    </div>
                </div>
